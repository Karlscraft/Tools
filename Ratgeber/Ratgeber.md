...
Karlscraft ist ein **stark gemoddeter Roleplay-Minecraft-Server** – mit über **400 Mods** gehört er zu den umfangreichsten Modpacks, die du dir vorstellen kannst. Unser großes Ziel: die badische Großstadt **Karlsruhe im Maßstab 1:1** originalgetreu in Minecraft nachzubauen – Straßen, Gebäude, Plätze, einfach alles.

Das macht Karlscraft zu mehr als nur einem normalen Survival-Server. Du baust nicht irgendwo in der Wildnis, sondern wirst Teil eines wachsenden, lebendigen Abbilds einer echten Stadt – inklusive eigener Wirtschaft, eigenem Klima und einer aktiven Roleplay-Community.
...
Wenn du zum ersten Mal auf Karlscraft joinst, bekommst du automatisch die Rolle **[Gast]**. Mit dieser Rolle kannst du **noch nicht mit dem Server interagieren** – du kannst also weder bauen, noch handeln, noch wirklich mitspielen.

Um das zu ändern, brauchst du die Rolle **[Bewohner]**. Diese erhältst du, indem du die **[Verifizierung](https://raw.githubusercontent.com/Karlscraft/Tools/refs/heads/main/Verifizierung/Verifizierung.html)** selbstständig durchführst. Erst danach kannst du wirklich losspielen.
...
Beim allerersten Join schenkt dir der Server zwei nützliche Pakete:

- 🧊 **Eine komplette Arktisrüstung** – damit du die kalten Winter und Nächte auf Karlscraft überstehst, ohne sofort zu erfrieren.
- 🔧 **Ein Set aus vier Plastikwerkzeugen** – praktisch für den Anfang, damit du die ersten Blöcke abbauen und dich gegen die ersten Monster verteidigen kannst, ohne erst stundenlang nach Materialien suchen zu müssen.
...
Vergiss alles, was du aus Vanilla-Minecraft über Tag-Nacht-Zyklen weißt: Auf Karlscraft dauert ein **Ingame-Tag ganze 24 Stunden** statt der üblichen 20 Minuten.
...
### Wie kommt das Geld auf dein Konto?

- ⭐ **Automatisch über Erfahrungspunkte:** Für jeden XP-Punkt, den du sammelst, wird dir automatisch **1€** gutgeschrieben. Das heißt, ganz nebenbei beim Spielen – Monster töten, Erze abbauen, Aufgaben erledigen – füllt sich dein Konto.
...
Neben dem digitalen Konto gibt es auf Karlscraft auch ein **offizielles Bargeldsystem** – mit echten Münzen im Spiel!

- 🪙 Die Münzen reichen im Wert von **0,01 € bis 10.000 €** und stammen aus der Mod **Thermal Foundation**.
- ⚖️ Bargeld wird **genauso anerkannt wie digitales Geld** auf dem Konto – es ist also vollwertig gleichgestellt, nur eben physisch im Inventar statt auf einem Konto.
...
- 🏃 **Wer zuerst kommt, malt zuerst** – freie Grundstücke gehören grundsätzlich demjenigen, der sie zuerst claimt.
- 🚫 **Horten ist nicht erwünscht.** Auch wenn dir theoretisch unendlich viele Grundstücke gehören dürfen, bringt jedes Grundstück **Verantwortung** mit sich.
- 🧱 **Bauverpflichtung:** Wenn du ein Grundstück kaufst, musst du es auch entsprechend bebauen – genau wie im echten Karlsruhe gibt es schließlich keine endlosen, ewig leeren Baulücken mitten in der Stadt.
...
Der klassische Text-Chat im Spiel wird auf Karlscraft eher selten genutzt. Du kannst ihn dir am besten wie eine ziemlich **irrelevante WhatsApp-Gruppe** vorstellen: gelegentlich nützlich, aber definitiv nicht der Ort, an dem das eigentliche Spiel passiert.

Die **echte Kommunikation** findet, wie oben beschrieben, über den **Proximity-Chat** statt.

Falls dich der Ingame-Chat eher stört als hilft, kannst du ihn auch komplett ausblenden:

> **Spielmenü → Optionen → Chateinstellungen → Chat: Nur Befehle anzeigen**
...
Völlig in Ordnung! Karlscraft zwingt dich nicht dazu, aktiv am Aufbau von Karlsruhe oder am Roleplay teilzunehmen. Wenn du einfach nur entspannt für dich spielen möchtest, gibt es eine simple Lösung:

🧭 **Lass dich weit entfernt vom Stadtzentrum (dem Nullmeridian) nieder.**

Die Logik dahinter: Je weiter du vom Zentrum entfernt baust, desto unwahrscheinlicher ist es, dass dein Platz für die Stadtentwicklung benötigt wird und du ihn räumen musst. Als grober Richtwert gilt ein **Sweetspot von ≥ 20.000 Blöcken** Entfernung vom Zentrum (Angabe ohne Gewähr – es ist eine Orientierungshilfe, keine feste Regel).
...
Karlscraft läuft **nicht durchgehend 24/7** – Strom- und Wartungskosten werden privat finanziert, daher fährt der Server automatisch herunter, wenn **30 Minuten lang kein Spieler online ist**.

Solltest du dich nicht verbinden können, hast du folgende Möglichkeiten:

- 💬 Kontaktiere uns über **Discord**.
- 📧 Oder schreib uns eine **[E-Mail](mailto:karlscraft@outlook.de)**.
